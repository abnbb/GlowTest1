...
public class BloomBlurRenderPassFeature : ScriptableRendererFeature
{
    ...
    public BlurSettings bs;


    public override void Create()
    {
        m_ScriptablePass = new BloomBlurRenderPass(bs);
        m_ScriptablePass.setUp(BlurShader);
